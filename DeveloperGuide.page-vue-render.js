...
with(this){return _c('ul',[_c('li',[_v("are letting agents")]),_v(" "),_c('li',[_v("has a need to manage a significant number of client's personal and rental information")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": manage many client's personal and rental information, such as name, phone number, address, rental start date, rental end date, monthly rent amount, etc.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I can …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("save a client's personal information")]),_v(" "),_c('td',[_v("contact them easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("save a client's rental information")]),_v(" "),_c('td',[_v("view their respective properties")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit a client's personal information")]),_v(" "),_c('td',[_v("modify their personal details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit a client's rental information")]),_v(" "),_c('td',[_v("modify their property's rental information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * * ")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a client's personal information")]),_v(" "),_c('td',[_v("clear my application when he/she is no longer my client")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a client's rental information")]),_v(" "),_c('td',[_v("clear my application when the property is not owned by my client anymore")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a client's personal information")]),_v(" "),_c('td',[_v("find the client easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a client's rental information")]),_v(" "),_c('td',[_v("find the client's property easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("colour code a client")]),_v(" "),_c('td',[_v("differentiate more important clients")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("attach files to a client")]),_v(" "),_c('td',[_v("attach important contracts to the respective clients")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("assign tags to clients")]),_v(" "),_c('td',[_v("differentiate clients by any interesting factors")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("autofill CLI commands")]),_v(" "),_c('td',[_v("easily assess the command line without typing the command again")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("export all client's personal information")]),_v(" "),_c('td',[_v("save it somewhere else")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("export a specific client's rental information")]),_v(" "),_c('td',[_v("save it somewhere else")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("send emails to a client")]),_v(" "),_c('td',[_v("schedule meetings with them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("set reminders for a client")]),_v(" "),_c('td',[_v("remember my schedule with individual client")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("lock my application")]),_v(" "),_c('td',[_v("protect my data")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add a client")])]),_v(" "),_c('li',[_c('p',[_v("User enters client's information")])]),_v(" "),_c('li',[_c('p',[_v("System validates user input")])]),_v(" "),_c('li',[_c('p',[_v("System adds new client information")])]),_v(" "),_c('li',[_c('p',[_v("System notifies user upon successful add operation")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. System detects error for invalid instruction")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System prompts error for invalid instruction")]),_v(" "),_c('li',[_v("3a2. User enters new instruction")]),_v(" "),_c('li',[_v("Steps 3a1-3a2 are repeated until instruction is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("3b. System detects error in client's information")]),_v(" "),_c('ul',[_c('li',[_v("3b1. System prompts error for invalid client's information")]),_v(" "),_c('li',[_v("3b2. User enters new client's information")]),_v(" "),_c('li',[_v("Steps 3b1-3b2 are repeated until client's information is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("3c. System detects duplicated client's information")]),_v(" "),_c('ul',[_c('li',[_v("3c1. System prompts error for duplicated client's information")]),_v(" "),_c('li',[_v("3c2. User enters new non-duplicated client's information")]),_v(" "),_c('li',[_v("Steps 3c1-3c2 are repeated until client's information is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 4.")])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, user chooses not proceed on with the operation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add rental information")])]),_v(" "),_c('li',[_c('p',[_v("User selects client")])]),_v(" "),_c('li',[_c('p',[_v("User enters client's rental information")])]),_v(" "),_c('li',[_c('p',[_v("System validates user input")])]),_v(" "),_c('li',[_c('p',[_v("System updates new client information")])]),_v(" "),_c('li',[_c('p',[_v("System notifies user upon successful add operation")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("4a. System detects error for invalid instruction")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System prompts error for invalid instruction")]),_v(" "),_c('li',[_v("4a2. User enters new instruction")]),_v(" "),_c('li',[_v("Steps 4a1-4a2 are repeated until instruction is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 4.")])]),_v(" "),_c('li',[_c('p',[_v("4b. System detects error for invalid client")]),_v(" "),_c('ul',[_c('li',[_v("4b1. System prompts error for invalid client")]),_v(" "),_c('li',[_v("4b2. User selects new client")]),_v(" "),_c('li',[_v("Steps 4b1-4b2 are repeated until selected client is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 4.")])]),_v(" "),_c('li',[_c('p',[_v("4c. System detects error in client's rental information")]),_v(" "),_c('ul',[_c('li',[_v("4c1. System prompts error for invalid client's rental information")]),_v(" "),_c('li',[_v("4c2. User enters new client's rental information")]),_v(" "),_c('li',[_v("Steps 4c1-4c2 are repeated until client's rental information is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 4.")])]),_v(" "),_c('li',[_c('p',[_v("4d. System detects duplicated client's rental information")]),_v(" "),_c('ul',[_c('li',[_v("4d1. System prompts error for duplicated client's rental information")]),_v(" "),_c('li',[_v("4d2. User enters new non-duplicated client's rental information")]),_v(" "),_c('li',[_v("Steps 4d1-4d2 are repeated until client's rental information is valid")])]),_v(" "),_c('p',[_v("Use case continues from step 5.")])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, user chooses not proceed on with the operation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to find a client")])]),_v(" "),_c('li',[_c('p',[_v("User enters keyword")])]),_v(" "),_c('li',[_c('p',[_v("System validates user input")])]),_v(" "),_c('li',[_c('p',[_v("System filters list of client based on keyword")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Edit a client's information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to edit a client's information.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the client information that he / she wants to update.")])]),_v(" "),_c('li',[_c('p',[_v("System validates user input.")])]),_v(" "),_c('li',[_c('p',[_v("System updates the client's information as requested.")])]),_v(" "),_c('li',[_c('p',[_v("System notifies user for successful modification.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. System detects error for invalid instruction.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System prompts error for invalid instruction.")]),_v(" "),_c('li',[_v("3a2. User enters new instruction.")]),_v(" "),_c('li',[_v("Steps 3a1-3a2 are repeated until the instruction is valid.")])]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("3b. System detects error for invalid client information.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. System prompts error for invalid client information.")]),_v(" "),_c('li',[_v("3b2. User enters new client information.")]),_v(" "),_c('li',[_v("Steps 3b1-3b2 are repeated until the client information is valid.")])]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("4a. System fails to update the client's information.")]),_v(" "),_c('ul',[_c('li',[_v("4a1. System prompts user that edit has failed.")])]),_v(" "),_c('p',[_v("Use case resumes from step 1 or user choose not to proceed and use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, User chooses not to proceed with the operation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit a client's rental information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to edit a client's rental information.")])]),_v(" "),_c('li',[_c('p',[_v("User enters the rental information that he / she wants to update.")])]),_v(" "),_c('li',[_c('p',[_v("System validates user input.")])]),_v(" "),_c('li',[_c('p',[_v("System updates the client's rental information as requested.")])]),_v(" "),_c('li',[_c('p',[_v("System notifies user for successful modification.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. System detects error for invalid instruction.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System prompts error for invalid instruction.")]),_v(" "),_c('li',[_v("3a2. User enters new instruction.")]),_v(" "),_c('li',[_v("Steps 3a1-3a2 are repeated until the instruction is valid.")])]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("3b. System detects error for invalid rental information.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. System prompts error for invalid rental information.")]),_v(" "),_c('li',[_v("3b2. User enters new rental information.")]),_v(" "),_c('li',[_v("Steps 3b1-3b2 are repeated until the rental information is valid.")])]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("4a. System fails to update the client's rental information.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System prompts user that edit has failed.")])]),_v(" "),_c('p',[_v("Use case resumes from step 1 or user choose not to proceed and use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, User chooses not to proceed with the operation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to delete a client and all related rental information")])]),_v(" "),_c('li',[_c('p',[_v("User types in a command consisting the index of the client")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user for confirmation")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the deletion")])]),_v(" "),_c('li',[_c('p',[_v("System deletes that client and all related rental information")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Delete a rental information from a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to delete a specific rental information from a client")])]),_v(" "),_c('li',[_c('p',[_v("User types in a command consisting the index of the client and rental information")])]),_v(" "),_c('li',[_c('p',[_v("System prompts the user for confirmation")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the deletion")])]),_v(" "),_c('li',[_c('p',[_v("System deletes that rental information")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("User")]),_v(": A letting agent that is using TrueRental to manage the contact information of their clients")]),_v(" "),_c('li',[_c('strong',[_v("Client")]),_v(": An individual that is renting a property from a letting agent")]),_v(" "),_c('li',[_c('strong',[_v("Letting agent")]),_v(": An individual that facilitates a property rental agreement")]),_v(" "),_c('li',[_c('strong',[_v("System")]),_v(": TrueRental desktop application")]),_v(" "),_c('li',[_c('strong',[_v("Client's information")]),_v(": A client's information containing name, phone number and email, not meant to be shared with others.")]),_v(" "),_c('li',[_c('strong',[_v("Client's rental information")]),_v(": A client's rental information containing address, rental start date, rental end date, rent due date, monthly rent amount, deposit amount, tenant list, not meant to be shared with others.")]),_v(" "),_c('li',[_c('strong',[_v("MSS")]),_v(": Main Success Scenario.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 16 Oct 2024, 16:03:00 GMT+8]")])])])}
}];
